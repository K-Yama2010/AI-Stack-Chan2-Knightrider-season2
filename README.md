...
〇　正常に動作しないとき<br>
　　　<br>
・会話モードで「わかりした」と表示された後に応答が止まるパターンが報告されております。お手数ですがその場合は下記の条件にて試してみてください。<br>
　<br>
  　　●wifi　もしくは　スマホのテザリング機能等、複数の接続先で会話してみる<br>
  <br>
 　　●STTのAPIkeyをOpenAI_APIkeyで使う（SDカード内、apikey.txtファイルの3行目）<br>
  <br>
  <br>
  <br>
  <br>
